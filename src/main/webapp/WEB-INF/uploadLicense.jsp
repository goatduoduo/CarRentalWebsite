                                ...
                                <TD style="PADDING-TOP: 8px" vAlign=top height=185><TABLE cellSpacing=0 cellPadding=0 width="100%" border=0>
                                    ...
                                    <TR>
                                        <TD style="PADDING-TOP: 8px" align=middle class=newsline>
                                            ...
                                            <form name="form1" method="post" action="uploadLicense2.do" onsubmit="return checkfrom()" enctype="multipart/form-data">
                                                ...
                                                <table width="98%" border="1" align="center" cellpadding="3" cellspacing="1" bordercolor="#529C33" style="border-collapse:collapse">
                                                    ...
                                                    <tr>
                                                        <td>驾驶证领取日期：</td>
                                                        <td><input name='licenseReceive' type='date' id='xingmingid' style="width: 300px;" />
                                                            &nbsp;*</td>
                                                    </tr>
                                                    <tr>
                                                        <td>驾驶证过期日期：</td>
                                                        <td><input name='licenseExpire' type='date' id='dianhuaid' style="width: 300px;" />
                                                            &nbsp;*</td>
                                                    </tr>
