                                        ...
                                        <TD style="PADDING-TOP: 8px" align=middle class=newsline>
                                            ...
                                            <form name="form1" method="post" action="register2.do" onsubmit="return checkfrom()">
                                                ...
                                                <table width="98%" border="1" align="center" cellpadding="3" cellspacing="1" bordercolor="#529C33" style="border-collapse:collapse">
                                                    ...
                                                    <tr>
                                                        <td>密码：</td>
                                                        <td><input name='pwd' type='password' id='passwordid' style="width: 300px;" />
                                                            &nbsp;*</td>
                                                    </tr>
                                                    <tr>
                                                        <td>确认密码：</td>
                                                    ...
                                                    <tr>
                                                        <td>身份证：</td>
                                                        <td><input name='identity' type='text' id='sfzid' style="width: 300px;" />
                                                            &nbsp;*</td>
                                                    </tr>
                                                    ...
                                                    <tr>
                                                        <td>手机号码：</td>
                                                        <td><input name='cellPhone' type='text' id='tejid' style="width: 300px;" />&nbsp;*</td>
                                                    </tr>
