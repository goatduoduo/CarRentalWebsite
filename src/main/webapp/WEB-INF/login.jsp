                ...
                <TR>
                    ...
                    <TD vAlign=top>
                        ...
                        <TABLE
                            ...
                            <TBODY>
                            <TR>
                                <TD style="PADDING-TOP: 8px" vAlign=top height=185>
                                    <TABLE cellSpacing=0 cellPadding=0 width="100%" border=0>
                                        <TBODY>
                                        <TR>
                                            <TD style="PADDING-TOP: 8px" align=middle class=newsline>
                                                ...
                                                <form name="form1" method="post" action="login2.do"
                                                    ...
                                                    <table width="98%" border="1" align="center" cellpadding="3"
                                                        ...
                                                        <tr>
                                                            <td>手机号：</td>
                                                            <td><input name='username' type='text' id='usernameid'
                                                                       style="width: 300px;"/>
                                                                &nbsp;*
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td>密码：</td>
                                                            <td><input name='password' type='password' id='passwordid'
                                                                       style="width: 300px;"/>
                                                                &nbsp;*
                                                            </td>
                                                        </tr>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <input type="submit" name="Submit5" value="登录"
                                                                       style="width:80px; height:30px; border:solid 1px #000000; color:#666666"/>
                                                                &nbsp; &nbsp; &nbsp; &nbsp;
