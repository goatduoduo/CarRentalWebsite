    ...
    <div class="mdui-row">
        ...
        <div class="mdui-col-xs-12 mdui-col-md-4">
            <table class="mdui-table mdui-table-hoverable update-little-table table-text-center">
                ...
                <tr>
                    <td>日租报价</td>
                    <td><input class="mdui-textfield-input" type="text" name="licensePlate" id='dailyRentid'
                    /></td>
                </tr>
                <tr>
                    <td>押金</td>
                    <td><input class="mdui-textfield-input" type="text" name="licensePlate" id='depositid'
                    /></td>
                </tr>
                <tr>
                    <td>保险费</td>
                    <td><input class="mdui-textfield-input" type="text" name="licensePlate" id='priceid'
                    /></td>
                </tr>
                <tr>
                    <td>手续费</td>
                    <td><input class="mdui-textfield-input" type="text" name="licensePlate" id='insuranceid'/></td>
                </tr>
    ...
    <div class="mdui-row mdui-m-y-4">
        <div class="mdui-col-xs-12 mdui-col-md-12">
            <table class="mdui-table mdui-table-hoverable update-little-table table-text-center">
                ...
                <tr>
                    <td>座位数</td>
                    <td><input class="mdui-textfield-input" type="text" name="location" id='seatsid'/></td>
                </tr>
                <tr>
                    <td>颜色</td>
                    <td><input class="mdui-textfield-input" type="text" name="location" id='colorid'/></td>
                </tr>
                <tr>
                    <td>简介</td>
                    <td><input class="mdui-textfield-input" type="text" name="location" id='infoid'/></td>
                </tr>
                </tbody>
            </table>
        </div>
        ...
        <div class="mdui-col">
            <a href="carreturn2.do">
                <button class="mdui-btn mdui-btn-block mdui-color-blue-400 mdui-ripple mdui-m-r-1">
                    <div class="mdui-text-color-white">提交</div>
                </button>
            </a>
        </div>
        <div class="mdui-col">
