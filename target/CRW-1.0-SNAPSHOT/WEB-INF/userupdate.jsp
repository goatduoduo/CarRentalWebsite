                                        ...
                                        <TD style="PADDING-TOP: 8px" align=middle class=newsline>
                                            ...
                                            <form name="form1" method="post" action="userupdate2.do" onsubmit="return checkfrom()">
                                                ...
                                                <table width="98%" border="1" align="center" cellpadding="3" cellspacing="1" bordercolor="#529C33" style="border-collapse:collapse">
                                                    ...
                                                    <tr>
                                                        <td>用户名：</td>
                                                        <td><input name='userName' value="${bean.userName}" type='text' id='nameid' style="width: 300px;" />
                                                            &nbsp;*</td>
                                                    </tr>

                                                    <tr>
                                                        <td>手机号码：</td>
                                                        <td><input name='cellPhone' value="${bean.cellPhone }" type='text' id='tejid' style="width: 300px;" />&nbsp;*</td>
                                                    </tr>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td><a href="uploadLicense.do?" type="button" class="btn btn-danger">上传证件！</a>
                                                        <td>新用户需要上传身份证、驾驶证和信用卡以审核！</td>
                                                    </tr>
                                                </table>
                                            </form>
